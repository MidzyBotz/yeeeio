...
haikal.sendMessage(m.chat, anakau, {quoted: Kiki})
}
...
quoted: Kiki.quoted && m.quoted.fakeObj
})
...
if (/image/.test(mime)) {
anu = await haikal.downloadAndSaveMediaMessage(quoted)
haikal.sendMessage(m.chat, {image: {url: anu},viewOnce : true},{quoted: Kiki })
} else if (/video/.test(mime)) {
anu = await haikal.downloadAndSaveMediaMessage(quoted)
haikal.sendMessage(m.chat, {video: {url: anu},viewOnce : true},{quoted: Kiki })
}
}
break
//=================================================//
...
haikal.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: Kiki })
}
break
//=================================================//
case 'hidetag': {
...
if (!isBotAdmins) throw SiGroupadmin(from)
if (!isAdmins) throw sticAdmin(from)
haikal.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: Kiki })
}
break
//=================================================//
...
if (err) throw err
let buffer = fs.readFileSync(ran)
haikal.sendMessage(m.chat, { image: buffer }, { quoted: Kiki })
fs.unlinkSync(ran)
})
}
break
...
await haikal.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted: Kiki })
...
let media = await haikal.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await haikal.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted: Kiki })
await fs.unlinkSync(media)
}
break
//=================================================//
...
haikal.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },caption: teks }, { quoted: Kiki })
}
break
//=================================================//
case 'google': {
...
haikal.sendMessage(m.chat, mllo, { quoted: Kiki })
})
}
break
//=================================================//
...
haikal.sendMessage(m.chat, kals, { quoted: Kiki })
}
break
//=================================================//
...
if (media.filesize >= 100000) return anjay('File Melebihi Batas '+util.format(media))
haikal.sendImage(m.chat, media.thumb, `⭔ Title : ${media.title}\n⭔ File Size : ${media.filesizeF}\n⭔ Url : ${urls[text - 1]}\n⭔ Ext : MP3\n⭔ Resolusi : ${args[1] || '128kbps'}`, m)
haikal.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted: Kiki })
}
break
//=================================================//
case 'getvideo': {
...
if (media.filesize >= 100000) return anjay('File Melebihi Batas '+util.format(media))
haikal.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `⭔ Title : ${media.title}\n⭔ File Size : ${media.filesizeF}\n⭔ Url : ${urls[text - 1]}\n⭔ Ext : MP3\n⭔ Resolusi : ${args[1] || '360p'}` }, { quoted: Kiki })
}
break
//=================================================//
case 'pinterest': {
...
haikal.sendMessage(m.chat, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted: Kiki })
}
break
//=================================================//
case 'couple': {
...
let random = anu[Math.floor(Math.random() * anu.length)]
haikal.sendMessage(m.chat, { image: { url: random.male }, caption: `Couple Male` }, { quoted: Kiki })
haikal.sendMessage(m.chat, { image: { url: random.female }, caption: `Couple Female` }, { quoted: Kiki })
}
break
//=================================================//
...
haikal.sendMessage(m.chat, ko, { quoted: Kiki })
}
break
//=================================================//
case 'wallpaper': {
...
haikal.sendMessage(m.chat, mlo, { quoted: Kiki })
}
break
//=================================================//
case 'wikimedia': {
...
haikal.sendMessage(m.chat, mbk, { quoted: Kiki })
}
break
//=================================================//
...
haikal.sendMessage(m.chat, anualas, { quoted: Kiki })
}
break
//=================================================//
...
haikal.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg' }, { quoted: Kiki })
}
break
//=================================================//
case 'iqra': {
